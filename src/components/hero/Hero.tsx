...
import Image3 from '../../assets/svg/threeicon.png'
                        ...
                        <div className="grid md:grid-cols-3 gap-5 p-3">
                            <div className="flex space-x-2 sm:space-x-4">
                                <svg width="57" height="69" viewBox="0 0 57 69" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <defs>
                                        <filter id="filter0_b_1_420" x="6.21533" y="6.54098" width="53.5693" height="60.3094" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                            ...
                            <div className="flex space-x-2 sm:space-x-4">
                                <svg width="69" height="69" viewBox="0 0 57 63" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <defs>
                                        <filter id="filter0_b_1_428" x="6.21533" y="7.54098" width="53.5693" height="60.3094" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                                            <feFlood flood-opacity="0" result="BackgroundImageFix" />
                                            <feGaussianBlur in="BackgroundImageFix" stdDeviation="2.5" />
                            ...
                            <div className="flex space-x-2 sm:space-x-4">
                                <img src={Image3} alt="threeicon" />
                                {/* <svg width="69" height="69" viewBox="0 0 57 62" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <defs>
                                        <filter id="filter0_b_1_436" x="6.21533" y="6.54098" width="53.5693" height="60.3094" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                                            <feFlood flood-opacity="0" result="BackgroundImageFix" />
                                            <feGaussianBlur in="BackgroundImageFix" stdDeviation="2.5" />
            ...
            <section>
                <div className='bg-[#F9FBFD] py-10'>
                    ...
                    <div className="max-w-md mx-auto p-5 bg-[#F2F3F8]">
                        <form>
                            <div className="mb-2">
                                <input type="email" id="email" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-4 placeholder-[#111113]::placeholder" placeholder="Name" required />
                            </div>
                            <div className="mb-2">
                                <input type="password" id="password" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-4 placeholder-[#111113]::placeholder" placeholder="Mail" required />
                            </div>
                            <div className="mb-2">
                                <input type="password" id="repeat-password" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-4 placeholder-[#111113]::placeholder" placeholder="Phone" required />
                            </div>
