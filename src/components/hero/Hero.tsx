            ...
            <section>
                <div className="d relative">
                    ...
                    <div className="max-w-7xl  flex flex-col items-center px-4 py-10 pb-24 mx-auto text-center  md:py- md:px-10 lg:px-32">
                        <h1 className="text-5xl font-semibold leading-none sm:text-7xl xl:max-w-3xl">Enterprise reseller of <span className="text-[#2568FF] whitespace-nowrap">Starlink Kit</span> in Nigeria</h1>
